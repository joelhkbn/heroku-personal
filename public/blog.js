...
function editBlog(event) {
  ...
  let title = document.getElementById('edit-blog-title').value
  let content = document.getElementById('edit-blog-content').value
  let image = document.getElementById('edit-blog-image')
